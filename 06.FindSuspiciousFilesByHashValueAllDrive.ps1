<#
Script Name 	:06.FindSuspiciousFilesByHashValueAllDrive.ps1
...
Version			:1.0
Last modified	:27/03/2022 - 16h00
...
# *** The following two hashes (SHA256 and MD5) of the PNG image file, it was used on 03/25/2022 with steganography to deploy the 'Serpent' Backdoor on organizations in France.***
...
# End of list
$Algorithms = @('SHA256')
#$Algorithms = @('SHA256','SHA1','MD5') # you can use only one algorithm if your hash list is of the same hash type.
